...
export default function Spinner(
  { bgtextcolor, fillcolor, height, width, darktextcolor }: SpinnerProps,
  props: any
) {
  return (
    <svg
      className={` ${width ? width : "w-8"} ${height ? height : "h-8"} ${
        bgtextcolor ? bgtextcolor : "text-gray-200"
      } ${fillcolor ? fillcolor : "fill-blue-600"}  ${
        darktextcolor ? darktextcolor : "dark:text-gray-600"
      } mr-2  animate-spin
      dark:text-gray-600
      `}
      viewBox="0 0 100 101"
